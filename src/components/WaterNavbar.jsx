...
const WaterNavbar = ({ activeTab, setActiveTab }) => {
  return (
    <nav className="bg-gradient-to-r from-blue-900 via-blue-700 to-blue-600 text-white p-4 shadow-md sticky top-0 z-50">
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        <h1 className="text-2xl font-bold tracking-wide flex items-center gap-2">
          <span role="img" aria-label="water">💧</span> Water Pollution
        </h1>
